...
const Sidebarr = () => {
  ...
  const userCurren = useUser(); // Lấy thông tin người dùng
  ...
  }, [userCurren]); // Lắng nghe sự thay đổi của userCurren
                    ...
                    >
                      ...
                      {child.text === "Đăng tin" ? (
                        ...
                        <Link
                          ...
                          style={{
                            color:
                              lastSegment === "danh-sach" ? "red" : "black",
                          }}
                        >
                          {child.text}
                        </Link>
                        ...
                        <Link
                          style={{
                            color:
                              lastSegment === "phan-tich" ? "red" : "black",
                          }}
                          to="/quan-ly/phan-tich"
                        >
                          {child.text}
                        </Link>
                      )}
